...
def test(params):
    ...
    model = NewCRFDepth(version='large07', inv_depth=False, max_depth=args.max_depth,min_depth=args.min_depth)
    ...
    with torch.no_grad():
        for step, sample in enumerate(tqdm(dataloader.data)):
            ...
            # print('pred_depth--',pred_depth)
            cv2.imwrite('whu_image.png', pred_depth)
    ...
    for s in tqdm(range(num_test_samples)):
        ...
        pred_depth_scaled = pred_depth*64
